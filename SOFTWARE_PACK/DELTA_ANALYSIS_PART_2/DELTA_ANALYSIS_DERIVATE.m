...
start=export_start*10e03%(export_start*10e05)/250;
stop=export_stop*10e03%(export_stop*10e05)/250;
...
start_h=(export_start*fss)*10e03;
stop_h=(export_stop*fss)*10e03;
...
start=(export_start*10e03)%10e05)/250;
stop=(export_stop*10e03)%10e05)/250;
