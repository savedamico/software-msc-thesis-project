...
if(val_WAKE)
    ...
    if(val_LF)
        ...
        TEST2(1,1)=vartestn(LF_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_HF)
        ...
        TEST2(2,1)=vartestn(HF_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_LFHF)
        ...
        TEST2(3,1)=vartestn(LFHF_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_nLF)
        ...
        TEST2(4,1)=vartestn(nLF_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_nHF)
        ...
        TEST2(5,1)=vartestn(nHF_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_nLFHF)
        ...
        TEST2(6,1)=vartestn(nLFHF_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_PCoer)
        ...
        TEST2(7,1)=vartestn(PCoer_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_PIncoer)
        ...
        TEST2(8,1)=vartestn(PIncoer_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_IncoerCoer)
        ...
        TEST2(9,1)=vartestn(IncoerCoer_WAKE_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off'); 
    end    
...
if(val_REM) 
    ...
    if(val_LF)
        ...
        TEST(1,1)=ranksum(DATA_PAT(:,1),DATA_CON(:,1));
        TEST2(1,1)=vartestn(LF_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_HF)
        ...
        TEST(2,1)=ranksum(DATA_PAT(:,2),DATA_CON(:,2));
        TEST2(2,1)=vartestn(HF_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_LFHF)
        ...
        TEST(3,1)=ranksum(DATA_PAT(:,3),DATA_CON(:,3));
        TEST2(3,1)=vartestn(LFHF_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_nLF)
        ...
        TEST(4,1)=ranksum(DATA_PAT(:,4),DATA_CON(:,4));
        TEST2(4,1)=vartestn(nLF_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_nHF)
        ...
        TEST(5,1)=ranksum(DATA_PAT(:,5),DATA_CON(:,5));
        TEST2(5,1)=vartestn(nHF_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_nLFHF)
        ...
        TEST(6,1)=ranksum(DATA_PAT(:,6),DATA_CON(:,6));
        TEST2(6,1)=vartestn(nLFHF_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_PCoer)
        ...
        TEST(7,1)=ranksum(DATA_PAT(:,7),DATA_CON(:,7));
        TEST2(7,1)=vartestn(PCoer_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_PIncoer)
        ...
        TEST(8,1)=ranksum(DATA_PAT(:,8),DATA_CON(:,8));
        TEST2(8,1)=vartestn(PIncoer_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_IncoerCoer)
        ...
        TEST(9,1)=ranksum(DATA_PAT(:,9),DATA_CON(:,9));
        TEST2(9,1)=vartestn(IncoerCoer_REM_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off'); 
    end    
...
if(val_N2)
    ...
    if(val_LF)
        ...
        TEST(1,1)=ranksum(DATA_PAT(:,1),DATA_CON(:,1));
        TEST2(1,1)=vartestn(LF_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_HF)
        ...
        TEST(2,1)=ranksum(DATA_PAT(:,2),DATA_CON(:,2));
        TEST2(2,1)=vartestn(HF_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_LFHF)
        ...
        TEST(3,1)=ranksum(DATA_PAT(:,3),DATA_CON(:,3));
        TEST2(3,1)=vartestn(LFHF_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_nLF)
        ...
        TEST(4,1)=ranksum(DATA_PAT(:,4),DATA_CON(:,4));
        TEST2(4,1)=vartestn(nLF_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_nHF)
        ...
        TEST(5,1)=ranksum(DATA_PAT(:,5),DATA_CON(:,5));
        TEST2(5,1)=vartestn(nHF_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_nLFHF)
        ...
        TEST(6,1)=ranksum(DATA_PAT(:,6),DATA_CON(:,6));
        TEST2(6,1)=vartestn(nLFHF_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_PCoer)
        ...
        TEST(7,1)=ranksum(DATA_PAT(:,7),DATA_CON(:,7));
        TEST2(7,1)=vartestn(PCoer_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_PIncoer)
        ...
        TEST(8,1)=ranksum(DATA_PAT(:,8),DATA_CON(:,8));
        TEST2(8,1)=vartestn(PIncoer_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_IncoerCoer)
        ...
        TEST(9,1)=ranksum(DATA_PAT(:,9),DATA_CON(:,9));
        TEST2(9,1)=vartestn(IncoerCoer_N2_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off'); 
    end    
...
if(val_N3)
    ...
    if(val_LF)
        ...
        TEST2(1,1)=vartestn(LF_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(1,2)=vartestn(LF_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(1,3)=vartestn(LF_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    ...
    if(val_HF)
        ...
        TEST2(2,1)=vartestn(HF_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(2,2)=vartestn(HF_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(2,3)=vartestn(HF_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    ...
    if(val_LFHF)
        ...
        TEST2(3,1)=vartestn(LFHF_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(3,2)=vartestn(LFHF_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(3,3)=vartestn(LFHF_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    ...
    if(val_nLF)
        ...
        TEST2(4,1)=vartestn(nLF_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(4,2)=vartestn(nLF_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(4,3)=vartestn(nLF_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_nHF)
        ...
        TEST2(5,1)=vartestn(nHF_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(5,2)=vartestn(nHF_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(5,3)=vartestn(nHF_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    end
    ...
    if(val_nLFHF)
        ...
        TEST2(6,1)=vartestn(nLFHF_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(6,2)=vartestn(nLFHF_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(6,3)=vartestn(nLFHF_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_PCoer)
        ...
        TEST2(7,1)=vartestn(PCoer_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(7,2)=vartestn(PCoer_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(7,3)=vartestn(PCoer_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_PIncoer)
        ...
        TEST2(8,1)=vartestn(PIncoer_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(8,2)=vartestn(PIncoer_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(8,3)=vartestn(PIncoer_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    end    
    ...
    if(val_IncoerCoer)
        ...
        TEST2(9,1)=vartestn(IncoerCoer_N3_Ready(:,[1 2]),'testtype','LeveneAbsolute','display','off');
        TEST2(9,2)=vartestn(IncoerCoer_N3_Ready(:,[1 3]),'testtype','LeveneAbsolute','display','off');
        TEST2(9,3)=vartestn(IncoerCoer_N3_Ready(:,[2 3]),'testtype','LeveneAbsolute','display','off');
    end    
